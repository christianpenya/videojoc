...
public:
    ...
    Quaternion(Vector3<T> c, T r) : x(c.x), y(c.y), z(c.z), w(r){}
    ...
    Quaternion Conjugate(void) const {
        return Quaternion(-GetComplex(), GetReal());
    }
    ...
    * represented by a unit quaternion.
    */
    Matrix44<T> GetRightMatrix() const {
        return Matrix44<T>(
            +w, -z, y, -x,
            +z, w, -x, -y,
            -y, x, w, -z,
    ...
    */
    Vector4<T> GetVector() const { return Vector4<T>(x, y, z, w); }
    ...
    */
    Matrix33<T> GetRotationMatrix() const {
        return Matrix33<T>(
    ...
    */
    Vect3f Multiply(const Vector3<T>& v) const {
    ...
    * so that Q = Qxy * Qz.
    */
    void DecoupleX(Quaternion* Qyz, Quaternion* Qx) const {
        Vector3<T> xtt(1, 0, 0);
    ...
    * so that Q = Qxy * Qz.
    */
    void DecoupleY(Quaternion* Qxz, Quaternion* Qy) const {
        Vector3<T> ytt(0, 1, 0);
    ...
    */
    bool Compare(const Quaternion& q1) {
    ...
    static Vector3<T> Rotate(const Vector3<T>& v, const Quaternion& q)
    {
        Vector3<T> vprime;
...
//--------------------------------------------------------------------------
// TIPOS DE QUATERNIONES CON TIPOS CONCRETOS DE DATOS
//--------------------------------------------------------------------------
typedef Quaternion<float> Quatf;
typedef Quaternion<double> Quatd;
typedef Quaternion<int32>  Quati;
typedef Quaternion<uint32> Quatu;
typedef Quaternion<uint8>  Quatu8;
typedef Quaternion<uint16> Quatw;
