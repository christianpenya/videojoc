...
public:     
    ...
    virtual uint32_t GetSize() const { return sizeof(T); };     
...
template<typename T> void* CTemplatedMaterialParameter<T>::GetAddr(int index = 0) const { return (void*)((float*)&m_Value + index); }
