...
public:
    ...
    CTemplatedMaterialParameter(const std::string& aName, const T &Value, float ImGuiMin, float ImGuiMax, CMaterial::TParameterType aType)
        : CMaterialParameter(aName, ImGuiMin, ImGuiMax, aType)
        , m_Value(Value)
    {}
