...
public:
    ...
    CMaterialParameter(const std::string& aName, float ImGuiMin, float ImGuiMax, CMaterial::TParameterType aType)
        : CName(aName), m_Type(aType), m_ImGuiMin(ImGuiMin), m_ImGuiMax(ImGuiMax) {};
