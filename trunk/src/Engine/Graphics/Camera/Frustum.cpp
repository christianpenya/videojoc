#include "Frustum.h"
#include "Graphics/Mesh/AxisAlignedBoundingBox.h"
...
bool CFrustum::IsVisible(const CAxisAlignedBoundingBox &aAABB) const
{
    const Vect3f& Max = aAABB.GetMax();
    const Vect3f Min = aAABB.GetMin();
