...
namespace date_time {
  ...
  public:
    ...
    static typename date_type::ymd_type local_day_ymd() 
    {
	  ...
	  // JV - I have added these casts to suppress warning C4244 caused because struct tm members are ints and 
	  // gregorian::date expects unsigned shorts for year,month and day
	  // Notice that this shall be included in boost 1.44 according to this: https://svn.boost.org/trac/boost/ticket/2757
      return ymd_type(static_cast<date_type::year_type::value_type>(curr->tm_year + 1900), 
                      static_cast<date_type::month_type::value_type>(curr->tm_mon + 1), 
                      static_cast<date_type::day_type::value_type>(curr->tm_mday));
    }
