...
enum AkAudioAPI
{
	AkAPI_XAudio2 = 1 << 0,								///< Use XAudio2 (preferred API on Windows)
	AkAPI_DirectSound = 1 << 1,							///< Use DirectSound
	AkAPI_Wasapi = 1 << 2,								///< Use Wasapi 
...
struct AkPlatformInitSettings
{
	...
	AkUInt32			idAudioDevice;			///< Device ID to use for the main audio output, as returned from AK::GetDeviceID or AK::GetDeviceIDFromName.  
												///< This is usable only when the AkInitSettings.eMainOutputType is set to AkAPI_Wasapi or AkAPI_XAudio2 (or AkAPI_Default which selects XAudio2).
};
